...
def getListData(url,cont):
    ...
    if isOrNo:
        ...
        xpathName = "//div[1]/ul/li/div[3]/p[1]/a/text()"
        # 这个需要在调整一下
        xpathZy = "//div[6]/div[1]/ul/li/div[2]"

        nameList = selector.xpath(xpathName)
        zyList = selector.xpath(xpathZy)
...
if __name__ == '__main__':
    # 每次开始  列表页的计数器就从零开始
    getListData("https://www.china.cn/search/184t.shtml?p=25",0)
